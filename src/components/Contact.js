...
import { Box, Button, Divider, IconButton, Stack, Avatar, Dialog, DialogContent, DialogContentText, DialogTitle, DialogActions, Slide, } from '@mui/material';
import { useTheme } from '@mui/material/styles';
import Typography from '@mui/material/Typography';
import { Bell, CaretRight, Phone, Prohibit, Star, VideoCamera, X, Trash } from 'phosphor-react';
  ...
  return (
    <Box sx={{ width: 320, height: "100vh" }}>
      <Stack sx={{ height: "100%" }}>
        {/* Header */}
        <Box sx={{
          boxShadow: "0px 0px 2px rgba(0,0,0.25)", width: "100%",
        ...
        <Stack sx={{ height: "100%", position: "relative", flexGrow: 1, overflowY: "scroll" }} p={3} spacing={3}>
          <Stack alignItems={"center"} direction="row" spacing={2}>
            ...
            <Stack spacing={0.5}>
              ...
              <Typography variant="body2" fontWeight={500}>{"91 729 2829 2992"}</Typography>
            </Stack>
          </Stack>
